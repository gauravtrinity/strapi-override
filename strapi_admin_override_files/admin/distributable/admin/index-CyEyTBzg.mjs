...
import { w as createContext, S as StrapiAppProvider, x as AuthProvider, L as LanguageProvider, T as Theme, N as NotificationsProvider, y as TrackingProvider, G as GuidedTourProvider, C as ConfigurationProvider, z as LANGUAGE_LOCAL_STORAGE_KEY, P as Page, B as getIn, D as setIn, r as useConfiguration, b as useTypedSelector, d as useTypedDispatch, E as setLocale, a as useAuth, e as useAPIErrorHandler, F as useForgotPasswordMutation, u as useNotification, p as useAppInfo, c as useTracking, m as useGuidedTour, H as useGetRegistrationInfoQuery, I as useRegisterAdminMutation, J as useRegisterUserMutation, o as login, K as useResetPasswordMutation, M as reducer$2, O as logout, R as RBAC, Q as THEME_LOCAL_STORAGE_KEY, U as getStoredToken, n as useQueryParams, V as useTypedStore } from './Theme-6doxg5FV.mjs';
...
const getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import('./AuthResponse-DWMQHpsW.mjs');
      return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import('./ListPage-CsVEwvZs.mjs');
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import('./SingleSignOnPage-D9DJpvPN.mjs');
        return {
  ...
  return /* @__PURE__ */ jsx(UnauthenticatedLayout, { children: /* @__PURE__ */ jsxs(LayoutContent, { children: [
    /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "center", gap: 3, children: [
      ...
      /* @__PURE__ */ jsx(Typography, { tag: "h1", variant: "alpha", textAlign: "center", children: formatMessage({
        id: "Auth.form.welcome.title",
        defaultMessage: "Welcome to ScoreMe!"
      }) }),
      /* @__PURE__ */ jsx(Typography, { variant: "epsilon", textColor: "neutral600", textAlign: "center", children: formatMessage({
        id: "Auth.form.register.subtitle",
        defaultMessage: "Credentials are only used to authenticate in ScoreMe. All saved data will be stored in your database."
      }) }),
      apiError ? /* @__PURE__ */ jsx(Typography, { id: "global-form-error", role: "alert", tabIndex: -1, textColor: "danger600", children: apiError }) : null
    ] }),
    /* @__PURE__ */ jsx(
...
const AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import('./Login-DB0gOMKE.mjs')).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import('./constants-DnV8gqNu.mjs')).FORMS,
    {
...
const ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-DeACD_K-.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import('./CreatePage-Ci_jLSIv.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-CsPTAWLo.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-D98Y1pwO.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-c3OhcFS1.mjs');
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import('./CreatePage-_zPybaEj.mjs');
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-DlKvCZKq.mjs').then(n => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-CrztH64f.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import('./ListView-DaBs-N3m.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import('./CreateView-Ca2wwsNx.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import('./EditViewPage-BYpd2eyV.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import('./CreateView-CkHWny7y.mjs');
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import('./ListView-DCkpRh-Y.mjs');
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import('./EditView-BpK3Too3.mjs');
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-D1Pn59jk.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-CK0kBY8D.mjs');
      return {
  ...
  {
    lazy: async () => {
      await import('./PurchaseSingleSignOn-uX_I0_dy.mjs');
      return {
        Component: null
      };
    },
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import('./PurchaseContentHistory-75X2tuoQ.mjs');
      return {
...
const getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import('./UseCasePage-DrUQwK0K.mjs');
      return {
...
const getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import('./HomePage-BrO-IGaT.mjs');
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import('./ProfilePage-TEIOF3F1.mjs');
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import('./MarketplacePage-CkBEZbM-.mjs');
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import('./Layout-kLGKxSBI.mjs');
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import('./ApplicationInfoPage-DrOhT9OV.mjs');
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import('./AuthenticatedLayout-Br6d82dC.mjs');
              return {
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(
      this.configurations.locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({})), `./translations/${locale}.js`, 3);
          return { data, locale };
        } catch {
          try {
            const { default: data } = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"./translations/ca.json": () => import('./ca-C2qrL5wX.mjs'),"./translations/de.json": () => import('./de-DJOrgE3X.mjs'),"./translations/en.json": () => import('./en-xaiylVvT.mjs')})), `./translations/${locale}.json`, 3);
            return { data, locale };
          } catch {
